...
import { FaCode, FaCogs, FaRocket, FaShieldAlt, FaChartLine, FaUsers } from 'react-icons/fa';

const features = [
  {
    title: "Custom Software Solutions",
    description: "Tailored software applications designed for your business needs.",
    ...
    <main className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center px-4">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          >
            Custom software solutions powered by AI to transform your business
          </motion.p>
        </div>
      </section>
          ...
          >
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-4">
                At Synthotech.ai, we create cutting-edge software solutions that combine innovative design with powerful AI capabilities. Our approach focuses on delivering exceptional user experiences while leveraging the latest technologies.
              </p>
              <p className="text-gray-300 mb-4">
                We develop custom software applications that are optimized for performance, security, and scalability. Our AI integration enables smart features and personalized experiences that set your software apart.
              </p>
              <p className="text-gray-300">
                Our comprehensive software development services help businesses create powerful, feature-rich applications that drive efficiency and growth.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Comprehensive software development services powered by AI
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-300">We define software requirements and design architecture.</p>
              </div>
              <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Let's discuss how we can help you create powerful software with AI.
            </p>
            <motion.button
